...
(defvar glsl-extension-color "#FF55FF" ; KP hack: changed the color here
...
; KP hack: treat deprecated built-ins as normal built-ins
(defvar glsl-deprecated-builtins-face 'glsl-builtins-face)
...
; KP hack: deprecated sheprecated
(defvar glsl-deprecated-keyword-face 'glsl-keyword-face)
...
; KP hack: deprecated sheprecated again
(defvar glsl-deprecated-variable-name-face 'glsl-variable-name-face)
...
(progn
  ...
  (add-to-list 'auto-mode-alist '("\\.sc\\'" . glsl-mode)) ; KP hack: bgfx support
