 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'KPStandard
	...
	(unless (display-graphic-p)
	  `(tab-bar ((,class (:background ,bg4 :foreground ,fg1)))))
	(unless (display-graphic-p)
	  `(tab-bar-tab ((,class (:background ,bg1 :foreground ,fg1)))))
	(unless (display-graphic-p)
	  `(tab-bar-tab-inactive ((,class (:background ,bg4 :foreground ,fg2)))))
...
(provide-theme 'KPStandard)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; KPStandard-theme.el ends here
